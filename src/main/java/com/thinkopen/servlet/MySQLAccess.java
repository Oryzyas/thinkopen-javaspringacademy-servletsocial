...
public class MySQLAccess {
    ...
    public Message send(Message message, List<Integer> ids) throws SQLException {
    ...
    public int setReadFlag(MessageIO msgio, boolean read) throws SQLException {
